    ...
    >
      <div className="flex flex-col items-center justify-center w-full px-3 text-white bg-black bottom-0">
        ...
        <div className="footer-content mt-4 text-center">
          ...
          >
            <a href="/" className="text-white hover:text-lime-600 transition-colors duration-300">Home</a> | <a href="/about" className="text-white hover:text-lime-600 transition-colors duration-300">About</a> | <a href="/portfolio" className="text-white hover:text-lime-600 transition-colors duration-300">Portfolio</a> |{' '}
            <a href="/experience" className="text-white text-lg hover:text-lime-600 transition-colors duration-300">Experience</a> |{' '}  <a href="/contact" className="text-white hover:text-lime-600 transition-colors duration-300">Contact</a>
          </motion.p>
          <motion.p
